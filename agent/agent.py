...
class Agent(object):
    ...
    def action(self, dt, sensors_data):
        ...
        agent_cartesian_goal = self.planned_traj[min(self.replanning_timer, len(self.planned_traj))]  # After the traj ran out, always use the last traj point for reference.
