...
<<<<<<< HEAD
        ...
        "estimator": {"type":"UKFEstimator",            "spec":{"init_x":np.array([ 30.,20.0, 0., 0.]),"init_variance":.01*np.eye(4),"Rww":.001*np.eye(4),"Rvv":.001*np.eye(4),"alpha_ukf":1,"kappa_ukf":0.1,"beta_ukf":2,"time_sample":0.01,"kp":6,"kv":8}},
...
=======
        ...
        "model":     {"type":"LinearModel",             "spec":{"use_spec":0, "use_library":0, "model_name":'Ballbot', "time_sample":0.02, "disc_flag":1, "model_spec":None}},
...
>>>>>>> 1433335f1387a0d40c2fe796a37604c07a1f24f1
...
<<<<<<< HEAD
        "task":      {"type":"ReachingTask",    "spec":{}},
        "model":     {"type":"LinearModel",     "spec":{"use_library":0, "model_name":'Ballbot', "time_sample":0.02, "disc_flag":1}},
        "estimator": {"type":"UKFEstimator",  "spec":{"init_x":np.array([50.,20.0, 0., 0.]),"init_variance":.01*np.eye(4),"Rww":.001*np.eye(4),"Rvv":.001*np.eye(4),"alpha_ukf":1,"kappa_ukf":0.1,"beta_ukf":2,"time_sample":0.01,"kp":6,"kv":8}},
=======
        "task":      {"type":"FlatReachingTask",    "spec":{}},
        "model":     {"type":"LinearModel",     "spec":{"use_spec":0, "use_library":0, "model_name":'Ballbot', "time_sample":0.02, "disc_flag":1, "model_spec":None}},
        "estimator": {"type":"EKFEstimator",  "spec":{"init_x":np.array([50.,20.0, 0., 0.]),"init_variance":.01*np.eye(4),"Rww":.001*np.eye(4),"Rvv":.001*np.eye(4),"alpha_ukf":1,"kappa_ukf":0.1,"beta_ukf":2,"time_sample":0.01,"kp":6,"kv":8}},
>>>>>>> 1433335f1387a0d40c2fe796a37604c07a1f24f1
