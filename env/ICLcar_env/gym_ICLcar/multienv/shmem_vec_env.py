...
class ShmemVecEnv(VecEnv):
    ...
    def __init__(self, env_fns, spaces=None, subproc_worker=None):
        """
        If you don't specify observation_space, we'll have to create a dummy
        environment to get it.
        """
        subproc_worker = subproc_worker if subproc_worker else _subproc_worker
        if spaces:
        ...
        for env_fn, obs_buf in zip(env_fns, self.obs_bufs):
            ...
            proc = Process(target=subproc_worker,
